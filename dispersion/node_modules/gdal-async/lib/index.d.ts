...
export type MDArrayOptions<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>> = {
	origin: number[];
	span: number[];
	stride?: number[];
	data_type?: string;
...
export type TypedArray<T = number> = T extends number ? Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array | import('@petamoriken/float16').Float16Array | Float32Array | Float64Array : T extends bigint ? BigInt64Array | BigUint64Array : never
 ...
 *
 */
  export const Float16Array: typeof import('@petamoriken/float16').Float16Array
   ...
   * @type {string}
   */
  export const GDT_CFloat16: string
   ...
   * @type {string}
   */
  export const GDT_Float16: string
   ...
   * @type {string}
   */
  export const GDT_UInt64: string
 ...
 * @returns {PixelFunction}
 */
  export function toPixelFunc(pixelFn: (sources: TypedArray[], buffer: TypedArray, args: Record<string, string|number>, width: number, height: number) => void): PixelFunction
 ...
 * @returns {string}
 */
  export function wrapVRT(desc: VRTDescriptor): string
 ...
 * @return {Dataset}
 */
  create(filename: string, x_size?: number, y_size?: number, band_count?: number, data_type?: string, creation_options?: StringOptions): Dataset
 ...
 * @return {Promise<Dataset>}
 */
  createAsync(filename: string, x_size?: number, y_size?: number, band_count?: number, data_type?: string, creation_options?: StringOptions, callback?: callback<Dataset>): Promise<Dataset>
 ...
 * @return {Dataset}
 */
  createCopy(filename: string, src: Dataset, options?: StringOptions, strict?: boolean, jsoptions?: CreateOptions): Dataset
 ...
 * @return {Promise<Dataset>}
 */
  createCopyAsync(filename: string, src: Dataset, options?: StringOptions, strict?: boolean, jsoptions?: CreateOptions, callback?: callback<Dataset>): Promise<Dataset>
 ...
 * @return {Dataset}
 */
  open(path: string, mode?: string, options?: StringOptions): Dataset
 ...
 * @return {Promise<Dataset>}
 */
  openAsync(path: string, mode?: string, options?: StringOptions, callback?: callback<Dataset>): Promise<Dataset>
}
 ...
 */
  setStyleString(style: string|null|undefined): void
}
 ...
 * @return {T}
 */
  read<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(options: MDArrayOptions<T>): T
 ...
 */
  readAsync<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(options: MDArrayOptions<T>, callback?: callback<T>): Promise<T>
 ...
 */
  read<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, width: number, height: number, data?: T, options?: ReadOptions): T
 ...
 * @return {Promise<T>} A `TypedArray` of values.
 */
  readAsync<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, width: number, height: number, data?: T, options?: ReadOptions, callback?: callback<T>): Promise<T>
 ...
 * @param {ProgressCb} [options.progress_cb]
 */
  write<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, width: number, height: number, data?: T, options?: WriteOptions): void
 ...
 * @return {Promise<void>}
 */
  writeAsync<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, width: number, height: number, data?: T, options?: WriteOptions, callback?: callback<void>): Promise<void>
 ...
 * @return {T} A `TypedArray` of values.
 */
  readBlock<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, data?: T): T
 ...
 * @return {Promise<T>} A `TypedArray` of values.
 */
  readBlockAsync<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, data?: T, callback?: callback<T>): Promise<T>
 ...
 */
  writeBlock<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, data: T): void
 ...
 * @return {Promise<void>}
 */
  writeBlockAsync<T extends TypedArray<number> | TypedArray<bigint> = TypedArray<number>>(x: number, y: number, data: T, callback?: callback<void>): Promise<void>
 ...
 * @returns {VSIStat}
 */
  static stat(filename: string, bigint?: false): VSIStat
 ...
 */
  static statAsync(filename: string, bigint?: false, callback?: callback<VSIStat>): Promise<VSIStat>
